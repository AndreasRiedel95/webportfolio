<script>
  ...
  const template = {
    ...
    intro: {
      introTitle: "It all began with having Photoshop on the parents' computer and the drive to try something new...",
      introText: [
        'Very soon, I designed various posters for local events such as concerts and contests. I designed marketing footage and Flyers.',
        'Together with Photoshop, the interest in the twin-programs InDesign and Illustrator arose. As time went by, programming has been introduced to my world – and with it the opportunity to become even more creative. However, I did not turn away from classical poster design. I still like to engage and experiment in those fancy programs like Sketch or Photoshop. So stay tuned!',
