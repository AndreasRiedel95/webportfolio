...
<div class="main">
  ...
  <div class="max-width-800 width-100 margin-left-auto margin-right-auto pl-50 pr-50 pt-100 pb-100 color-white">
    <h1 class="headline1 mb-40">Impressum</h1>

    <h2 class="headline2 mb-20">Angaben gem&auml;&szlig; &sect; 5 TMG</h2>
    <p class="mb-30">Andreas Riedel<br /> Conrad-R&ouml;ntgen Str. 23<br /> 74321 Bietigheim-Bissingen</p>

    <h2 class="headline2 mb-20">Kontakt</h2>
    <p class="mb-30">Telefon: 017632579715<br /> E-Mail: andreas.riedel95@gmail.com</p>
    ...
    <p class="mb-30">Quelle: <a style="color: #fff" href="https://www.e-recht24.de">https://www.e-recht24.de</a></p>
  </div>
</div>
